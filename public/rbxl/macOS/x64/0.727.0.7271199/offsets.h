...
namespace offsets {
    ...
    namespace DataModel {
        ...
        inline constexpr uintptr_t GameLoaded = 0xA40;
    ...
    namespace Player {
        ...
        inline constexpr uintptr_t LocaleId = 0x660;
    ...
    namespace TaskScheduler {
        ...
        inline constexpr uintptr_t JobName = 0x518;
        inline constexpr uintptr_t JobStart = 0xD0;
        inline constexpr uintptr_t MaxFps = 0xB8;
        inline constexpr uintptr_t Pointer = 0x68504F0;
    }
    ...
    namespace TextButton {
        ...
        inline constexpr uintptr_t Font = 0x10A0;
        inline constexpr uintptr_t LineHeight = 0xEB0;
        inline constexpr uintptr_t LocalizedText = 0xDD0;
        inline constexpr uintptr_t MaxVisibleGraphemes = 0x10AC;
        inline constexpr uintptr_t Modal = 0x9CD;
        inline constexpr uintptr_t RichText = 0xFAE;
        inline constexpr uintptr_t Selected = 0x9CE;
        inline constexpr uintptr_t Text = 0xDD0;
        inline constexpr uintptr_t TextColor3 = 0x1088;
        inline constexpr uintptr_t TextDirection = 0xF50;
        inline constexpr uintptr_t TextScaled = 0xFA6;
        inline constexpr uintptr_t TextSize = 0x10B4;
        inline constexpr uintptr_t TextStrokeColor3 = 0x1094;
        inline constexpr uintptr_t TextStrokeTransparency = 0x10B8;
        inline constexpr uintptr_t TextTransparency = 0x10BC;
        inline constexpr uintptr_t TextTruncate = 0x10C0;
        inline constexpr uintptr_t TextWrapped = 0xFA8;
        inline constexpr uintptr_t TextXAlignment = 0x10C4;
        inline constexpr uintptr_t TextYAlignment = 0xEF8;
    }

    namespace TextLabel {
        inline constexpr uintptr_t ContentText = 0xB48;
        inline constexpr uintptr_t Font = 0xE18;
        inline constexpr uintptr_t LineHeight = 0xC28;
        inline constexpr uintptr_t LocalizedText = 0xB48;
        inline constexpr uintptr_t MaxVisibleGraphemes = 0xE24;
        inline constexpr uintptr_t RichText = 0xD26;
        inline constexpr uintptr_t Text = 0xB48;
        inline constexpr uintptr_t TextColor3 = 0xE00;
        inline constexpr uintptr_t TextDirection = 0xCC8;
        inline constexpr uintptr_t TextScaled = 0xD1E;
        inline constexpr uintptr_t TextSize = 0xE2C;
        inline constexpr uintptr_t TextStrokeColor3 = 0xE0C;
        inline constexpr uintptr_t TextStrokeTransparency = 0xE30;
        inline constexpr uintptr_t TextTransparency = 0xE34;
        inline constexpr uintptr_t TextTruncate = 0xE38;
        inline constexpr uintptr_t TextWrapped = 0xD20;
        inline constexpr uintptr_t TextXAlignment = 0xE3C;
        inline constexpr uintptr_t TextYAlignment = 0xC70;
    }
    ...
    namespace VisualEngine {
        ...
        inline constexpr uintptr_t Pointer = 0x655CCF0;
