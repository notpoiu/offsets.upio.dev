...
namespace offsets {
    ...
    inline constexpr const char* architecture = "x64";
    ...
    namespace GuiBase2D {
        ...
        inline constexpr uintptr_t AbsoluteRotation = 0x180;
    ...
    namespace Player {
        ...
        inline constexpr uintptr_t LocaleId = 0x650;
    ...
    namespace TaskScheduler {
        ...
        inline constexpr uintptr_t Pointer = 0x674D8F0;
    }
    ...
    namespace TextButton {
        ...
        inline constexpr uintptr_t ContentText = 0xDC8;
        inline constexpr uintptr_t Font = 0x1098;
        inline constexpr uintptr_t LineHeight = 0xEA8;
        inline constexpr uintptr_t LocalizedText = 0xDC8;
        inline constexpr uintptr_t MaxVisibleGraphemes = 0x10A4;
        inline constexpr uintptr_t Modal = 0x9C5;
        inline constexpr uintptr_t RichText = 0xFA6;
        inline constexpr uintptr_t Selected = 0x9C6;
        inline constexpr uintptr_t Text = 0xDC8;
        inline constexpr uintptr_t TextColor3 = 0x1080;
        inline constexpr uintptr_t TextDirection = 0xF48;
        inline constexpr uintptr_t TextScaled = 0xF9E;
        inline constexpr uintptr_t TextSize = 0x10AC;
        inline constexpr uintptr_t TextStrokeColor3 = 0x108C;
        inline constexpr uintptr_t TextStrokeTransparency = 0x10B0;
        inline constexpr uintptr_t TextTransparency = 0x10B4;
        inline constexpr uintptr_t TextTruncate = 0x10B8;
        inline constexpr uintptr_t TextWrapped = 0xFA0;
        inline constexpr uintptr_t TextXAlignment = 0x10BC;
        inline constexpr uintptr_t TextYAlignment = 0xEF0;
    }

    namespace TextLabel {
        inline constexpr uintptr_t ContentText = 0xB40;
        inline constexpr uintptr_t Font = 0xE10;
        inline constexpr uintptr_t LineHeight = 0xC20;
        inline constexpr uintptr_t LocalizedText = 0xB40;
        inline constexpr uintptr_t MaxVisibleGraphemes = 0xE1C;
        inline constexpr uintptr_t RichText = 0xD1E;
        inline constexpr uintptr_t Text = 0xB40;
        inline constexpr uintptr_t TextColor3 = 0xDF8;
        inline constexpr uintptr_t TextDirection = 0xCC0;
        inline constexpr uintptr_t TextScaled = 0xD16;
        inline constexpr uintptr_t TextSize = 0xE24;
        inline constexpr uintptr_t TextStrokeColor3 = 0xE04;
        inline constexpr uintptr_t TextStrokeTransparency = 0xE28;
        inline constexpr uintptr_t TextTransparency = 0xE2C;
        inline constexpr uintptr_t TextTruncate = 0xE30;
        inline constexpr uintptr_t TextWrapped = 0xD18;
        inline constexpr uintptr_t TextXAlignment = 0xE34;
        inline constexpr uintptr_t TextYAlignment = 0xC68;
    }
    ...
    namespace VisualEngine {
        ...
        inline constexpr uintptr_t Pointer = 0x64612C8;
