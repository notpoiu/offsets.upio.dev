 ...
 * Architecture: arm64
 * Time Taken: 58833 ms (58.833000 seconds)
 * Total Offsets: 273
 */
...
// clang-format off
namespace offsets {
    inline constexpr const char* roblox_version = "0.726.0.7261140";
    ...
    namespace GuiObject {
        ...
        inline constexpr uintptr_t BorderMode = 0x550;
        inline constexpr uintptr_t BorderSizePixel = 0x554;
        inline constexpr uintptr_t ClipsDescendants = 0x591;
        inline constexpr uintptr_t GuiState = 0x560;
        inline constexpr uintptr_t Interactable = 0x593;
        inline constexpr uintptr_t LayoutOrder = 0x568;
        inline constexpr uintptr_t Position = 0x4F8;
        inline constexpr uintptr_t Rotation = 0x168;
        inline constexpr uintptr_t Selectable = 0x594;
        inline constexpr uintptr_t SelectionOrder = 0x584;
        inline constexpr uintptr_t Size = 0x518;
        inline constexpr uintptr_t SizeConstraint = 0x588;
    ...
    namespace ModuleScript {
        ...
        inline constexpr uintptr_t Hash = 0xB0;
    ...
    namespace Player {
        inline constexpr uintptr_t AccountAge = 0x304;
        inline constexpr uintptr_t DisplayName = 0x138;
        inline constexpr uintptr_t HealthDisplayDistance = 0x334;
        inline constexpr uintptr_t LocaleId = 0x640;
        inline constexpr uintptr_t ModelInstance = 0x388;
    ...
    namespace TaskScheduler {
        ...
        inline constexpr uintptr_t Pointer = 0x643C650;
    }
    ...
    namespace TextButton {
        inline constexpr uintptr_t AutoButtonColor = 0x9AC;
        inline constexpr uintptr_t ContentText = 0xDB0;
        inline constexpr uintptr_t Font = 0x1080;
        inline constexpr uintptr_t LineHeight = 0xE90;
        inline constexpr uintptr_t LocalizedText = 0xDB0;
        inline constexpr uintptr_t MaxVisibleGraphemes = 0x108C;
        inline constexpr uintptr_t Modal = 0x9AD;
        inline constexpr uintptr_t RichText = 0xF8E;
        inline constexpr uintptr_t Selected = 0x9AE;
        inline constexpr uintptr_t Text = 0xDB0;
        inline constexpr uintptr_t TextColor3 = 0x1068;
        inline constexpr uintptr_t TextDirection = 0xF30;
        inline constexpr uintptr_t TextScaled = 0xF86;
        inline constexpr uintptr_t TextSize = 0x1094;
        inline constexpr uintptr_t TextStrokeColor3 = 0x1074;
        inline constexpr uintptr_t TextStrokeTransparency = 0x1098;
        inline constexpr uintptr_t TextTransparency = 0x109C;
        inline constexpr uintptr_t TextTruncate = 0x10A0;
        inline constexpr uintptr_t TextWrapped = 0xF88;
        inline constexpr uintptr_t TextXAlignment = 0x10A4;
        inline constexpr uintptr_t TextYAlignment = 0xED8;
    }

    namespace TextLabel {
        inline constexpr uintptr_t ContentText = 0xB28;
        inline constexpr uintptr_t Font = 0xDF8;
        inline constexpr uintptr_t LineHeight = 0xC08;
        inline constexpr uintptr_t LocalizedText = 0xB28;
        inline constexpr uintptr_t MaxVisibleGraphemes = 0xE04;
        inline constexpr uintptr_t RichText = 0xD06;
        ...
        inline constexpr uintptr_t TextTransparency = 0xE14;
        inline constexpr uintptr_t TextTruncate = 0xE18;
        inline constexpr uintptr_t TextWrapped = 0xD00;
        inline constexpr uintptr_t TextXAlignment = 0xE1C;
        inline constexpr uintptr_t TextYAlignment = 0xC50;
    }

    namespace Tool {
        inline constexpr uintptr_t CanBeDropped = 0x450;
        inline constexpr uintptr_t Enabled = 0x451;
        inline constexpr uintptr_t Grip = 0x420;
        inline constexpr uintptr_t GripForward = 0x438;
        inline constexpr uintptr_t GripPos = 0x444;
        inline constexpr uintptr_t GripRight = 0x420;
        inline constexpr uintptr_t GripUp = 0x42C;
        inline constexpr uintptr_t ManualActivationOnly = 0x452;
        inline constexpr uintptr_t RequiresHandle = 0x453;
        inline constexpr uintptr_t Tooltip = 0x408;
    }
    ...
    namespace VisualEngine {
        ...
        inline constexpr uintptr_t Pointer = 0x614A4A0;
    ...
    namespace Workspace {
        ...
        inline constexpr uintptr_t World = 0x3B8;
    }
