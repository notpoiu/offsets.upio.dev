...
// clang-format off
namespace offsets {
    inline constexpr const char* roblox_version = "0.725.0.7251138";
    ...
    namespace Player {
        ...
        inline constexpr uintptr_t HealthDisplayDistance = 0x330;
        inline constexpr uintptr_t LocaleId = 0x638;
        inline constexpr uintptr_t ModelInstance = 0x380;
        inline constexpr uintptr_t NameDisplayDistance = 0x340;
        inline constexpr uintptr_t Team = 0x288;
        inline constexpr uintptr_t TeamColor = 0x34C;
    ...
    namespace TaskScheduler {
        ...
        inline constexpr uintptr_t Pointer = 0x63A0800;
    }
    ...
    namespace TextButton {
        ...
        inline constexpr uintptr_t TextScaled = 0xD84;
    ...
    namespace Tool {
        inline constexpr uintptr_t CanBeDropped = 0x458;
        inline constexpr uintptr_t Enabled = 0x459;
        inline constexpr uintptr_t Grip = 0x428;
        inline constexpr uintptr_t GripForward = 0x440;
        inline constexpr uintptr_t GripPos = 0x44C;
        inline constexpr uintptr_t GripRight = 0x428;
        inline constexpr uintptr_t GripUp = 0x434;
        inline constexpr uintptr_t ManualActivationOnly = 0x45A;
        inline constexpr uintptr_t RequiresHandle = 0x45B;
        inline constexpr uintptr_t Tooltip = 0x410;
    }
    ...
    namespace VisualEngine {
        ...
        inline constexpr uintptr_t Pointer = 0x60B4720;
