...
namespace RobloxOffsets
{
    ...
    {
        public const string RobloxVersion = "0.725.0.7251138";
    ...
    public static class GuiObject
    {
        ...
        public const ulong BorderColor3 = 0x534;
        public const ulong BorderMode = 0x550;
        public const ulong BorderSizePixel = 0x554;
        public const ulong ClipsDescendants = 0x591;
        public const ulong GuiState = 0x560;
        public const ulong Interactable = 0x593;
        public const ulong LayoutOrder = 0x568;
        public const ulong Position = 0x4F8;
        public const ulong Rotation = 0x168;
        public const ulong Selectable = 0x594;
        public const ulong SelectionOrder = 0x584;
        public const ulong Size = 0x518;
        public const ulong SizeConstraint = 0x588;
        public const ulong Visible = 0x595;
        public const ulong ZIndex = 0x58C;
    }
    ...
    public static class Player
    {
        ...
        public const ulong HealthDisplayDistance = 0x330;
        public const ulong LocaleId = 0x638;
        public const ulong ModelInstance = 0x380;
        public const ulong NameDisplayDistance = 0x340;
        public const ulong Team = 0x288;
        public const ulong TeamColor = 0x34C;
        public const ulong UserId = 0x2B0;
    }

    public static class Players
    {
        public const ulong LocalPlayer = 0x128;
    }
    ...
    public static class TaskScheduler
    {
        ...
        public const ulong Pointer = 0x63A0800;
    }
    ...
    {
        public const ulong AutoButtonColor = 0x9AC;
        public const ulong ContentText = 0xDB0;
        public const ulong Font = 0x1080;
        public const ulong LineHeight = 0xE90;
        public const ulong LocalizedText = 0xDB0;
        public const ulong MaxVisibleGraphemes = 0x108C;
        public const ulong Modal = 0x9AD;
        public const ulong RichText = 0xF8E;
        public const ulong Selected = 0x9AE;
        public const ulong Text = 0xDB0;
        public const ulong TextColor3 = 0x1068;
        public const ulong TextDirection = 0xF30;
        public const ulong TextScaled = 0xD84;
        public const ulong TextSize = 0x1094;
        public const ulong TextStrokeColor3 = 0x1074;
        public const ulong TextStrokeTransparency = 0x1098;
        public const ulong TextTransparency = 0x109C;
        public const ulong TextTruncate = 0x10A0;
        public const ulong TextWrapped = 0xF88;
        public const ulong TextXAlignment = 0x10A4;
        public const ulong TextYAlignment = 0xED8;
    }

    public static class TextLabel
    {
        public const ulong ContentText = 0xB28;
        public const ulong Font = 0xDF8;
        public const ulong LineHeight = 0xC08;
        public const ulong LocalizedText = 0xB28;
        public const ulong MaxVisibleGraphemes = 0xE04;
        public const ulong RichText = 0xD06;
        ...
        public const ulong TextTransparency = 0xE14;
        public const ulong TextTruncate = 0xE18;
        public const ulong TextWrapped = 0xD00;
        public const ulong TextXAlignment = 0xE1C;
        public const ulong TextYAlignment = 0xC50;
    }

    public static class Tool
    {
        public const ulong CanBeDropped = 0x458;
        public const ulong Enabled = 0x459;
        public const ulong Grip = 0x428;
        public const ulong GripForward = 0x440;
        public const ulong GripPos = 0x44C;
        public const ulong GripRight = 0x428;
        public const ulong GripUp = 0x434;
        public const ulong ManualActivationOnly = 0x45A;
        public const ulong RequiresHandle = 0x45B;
        public const ulong Tooltip = 0x410;
    }
    ...
    public static class VisualEngine
    {
        ...
        public const ulong Pointer = 0x60B4720;
        public const ulong RenderView = 0xBA0;
    ...
    public static class Workspace
    {
        ...
        public const ulong ReadOnlyGravity = 0x960;
        public const ulong World = 0x3C0;
    }

    public static class World
    {
        public const ulong Gravity = 0x208;
        public const ulong Primitives = 0x258;
        public const ulong WorldSteps = 0x610;
    }
